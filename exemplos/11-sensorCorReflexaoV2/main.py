...
try:   
    ...
    while(True):
        print(SensorCorReflexao.valores)
        #print(SensorCorReflexao.le_reflexao())
        #print(SensorCorReflexao.le_hsv(1))
        # print(SensorCorReflexao.le_angulo_y())
        # print(SensorCorReflexao.le_angulo_x())
        sleep(0.3)
