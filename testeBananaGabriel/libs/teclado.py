...
class Teclado:
    ...
    def botaoParaEncerrarPrograma(self, botao = 3):
        """
        ...
        self.botaoEncerarCodigo = botao
        threadTeclado = threading.Thread(target=self._threadEncerrarPrograma, daemon=True)
        threadTeclado.start()


    def _threadEncerrarPrograma(self):
        """Função para monitorar o teclado em uma thread separada."""
        while True:
            entrada = self.leBotao(self.botaoEncerarCodigo)
